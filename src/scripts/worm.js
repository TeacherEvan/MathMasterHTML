...
class WormSystem {
  constructor() {
    ...
    this.SLIME_SPLAT_FADE_DURATION = 900;
  ...
  initialize() {
    ...
    if (
      this.wormContainer &&
      getComputedStyle(this.wormContainer).position === "static"
    ) {
