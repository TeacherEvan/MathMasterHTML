...
class LazyComponentLoader {
    ...
    getAllLockComponentPaths() {
        return [
            'lock-components/Line-1-transformer.html',
            'lock-components/line-2-transformer.html',
            'lock-components/line-3-transformer.html',
            'lock-components/line-4-transformer.html',
            'lock-components/Line-5-transformer.html',
            'lock-components/line-6-transformer.html'
        ];
    }
    ...
    async loadLockWithFeedback(level, container) {
        ...
        try {
            ...
            if (window.UXEnhancements && window.UXEnhancements.toast) {
                window.UXEnhancements.toast.success(`Lock level ${level} activated!`, 2000);
            }
            ...
            // Show error toast
            if (window.UXEnhancements && window.UXEnhancements.toast) {
                window.UXEnhancements.toast.error('Failed to load lock animation', 3000);
            }
